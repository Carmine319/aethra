...
function refineOffer(opportunity) {
  const source = opportunity && typeof opportunity === "object" ? opportunity : { name: String(opportunity || "offer") };
...
module.exports = { analyseFeedback, refineOffer };
