import { createLicenceOffer } from "./licensing";

export type DealTarget = "SME" | "operator" | "team";
...
export type DealPlan = {
  ...
  follow_on_licence: ReturnType<typeof createLicenceOffer>;
};

export function generateDeal(target: DealTarget = "SME"): DealPlan {
  return {
    target,
    steps: [
      {
